...
urlpatterns = [
    ...
    path("manager/job_listing", views.AdminJobListing.as_view(),
         name="admin_job_listing"),
    ...
    path('update-degree/<pk>/',
         views.DegreeUpdateView.as_view(), name="update-degree"),
    path('delete-degree/<pk>/',
         views.DegreeDeleteView.as_view(), name="delete-degree"),
    ...
    path('list-account-removal-requests/', views.AccountRemovalListView.as_view(),
         name="list-account-removal-request"),
    path("request-account-removal", views.remove_account_request,
         name="request-account-removal"),
    path("request-account-removal/<str:pk>/update/",
         views.update_account_removal_request, name="update-arr-status"),
    ...
    path('my-academic-recognition/', views.create_update_ar, name="create-ar"),
